...
def demo_fixed_day_assignment():
    ...
    checks = [
        (
            ...
            len([c for c in courses if c["jour"] != "Jour inconnu"]),
            len(courses),
        ),
        (
            ...
            len(
                [
                    ...
                    for c in courses
                    if any(
                        header in c["jour"] for header in ["Lundi 13", "Mardi 14", "Mercredi 15"]
                    )
                ]
            ),
            len(courses),
        ...
        (
            ...
            len(courses)
            - len([c for c in courses if "07 Octobre" in c["jour"] or "23 Octobre" in c["jour"]]),
            len(courses),
        ),
        ("Distribution cyclique fonctionnelle", success_count, len(courses)),
    ]
